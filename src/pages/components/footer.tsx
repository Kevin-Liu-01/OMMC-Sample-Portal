...
function Footer() {
  return (
    <footer className="relative overflow-hidden border-t-[1.5px] border-gray-600 bg-gray-200 text-center font-general text-white dark:bg-gray-900/95">
      <div className="z-5 pattern-opacity-30 pattern-dots absolute h-[100vh] w-[100vw] duration-150 pattern-bg-gray-200 pattern-gray-300 pattern-size-4 dark:pattern-gray-800 dark:pattern-bg-gray-900"></div>

      <div className="flex-row-1 z-20 mx-auto flex max-w-7xl justify-center">
        <div className="relative my-auto mr-4 flex flex-col md:mr-5">
          <Image
            ...
            width={400}
          />
          <div className="animate-blob1 absolute inset-0  left-0 right-1/2 top-0 bottom-0 transform-gpu rounded-full bg-red-700 opacity-[35%] blur-2xl dark:opacity-[40%] "></div>
        </div>
        <div className="flex flex-col pt-11">
          <div className="justify-left mb-2 mt-2 flex">
            <a
              href="https://www.youtube.com/channel/UCyphrZpMeuA1ATGPzlStsng"
              className="mr-9 transform text-gray-800 duration-150 ease-in-out hover:scale-105 hover:text-[#ff0000] dark:text-[#ff0000]"
            >
              <svg
                aria-hidden="true"
                focusable="false"
            ...
            <a
              ...
              className="mr-9 transform text-gray-800  duration-150 ease-in-out hover:scale-105 hover:text-[#1da1f2] dark:text-[#1da1f2]"
            >
              <svg
                aria-hidden="true"
                focusable="false"
            ...
            <a
              ...
              className="group mr-9 transform text-gray-800 duration-150 ease-in-out hover:scale-105 dark:text-gray-400 "
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="52 42 88 66"
              ...
              >
                <path
                  className="transition duration-150 ease-out group-hover:text-[#4285f4] dark:text-[#4285f4]"
                  fill="currentColor"
                  d="M58 108h14V74L52 59v43c0 3.32 2.69 6 6 6"
                />
                <path
                  className="transition duration-150 ease-out group-hover:text-[#34a853] dark:text-[#34a853]"
                  fill="currentColor"
                  d="M120 108h14c3.32 0 6-2.69 6-6V59l-20 15"
                />
                <path
                  className="transition duration-150 ease-out group-hover:text-[#fbbc04] dark:text-[#fbbc04]"
                  fill="currentColor"
                  d="M120 48v26l20-15v-8c0-7.42-8.47-11.65-14.4-7.2"
                />
                <path
                  className="transition duration-150 ease-out group-hover:text-[#ea4335] dark:text-[#ea4335]"
                  fill="currentColor"
                  d="M72 74V48l24 18 24-18v26L96 92"
                />
                <path
                  className="transition duration-150 ease-out group-hover:text-[#c5221f] dark:text-[#c5221f]"
                  fill="currentColor"
            ...
            <a
              ...
              className="group mr-4 transform text-gray-800 duration-150 ease-in-out hover:scale-105 dark:text-gray-300"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                className="absolute z-10 opacity-0 transition duration-150 ease-out group-hover:opacity-100 dark:opacity-100"
              >
                <defs>
                  <linearGradient
                    id="a"
